...
class LoRAManager:
    ...
    def load_lora_adapter_from_tensors(
        ...
        try:
            ...
            # DEBUG: log LoRA weight hashes after loading from tensors
            import hashlib
            ...
            for name, tensor in list(tensors.items()):
                print(
                    f"[DEBUG lora_sync] lora_name={lora_ref.lora_name} param={name} shape={list(tensor.shape)} hash={_hash_lora(tensor)}",
                    flush=True,
                )
